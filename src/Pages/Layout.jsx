...
const Layout = () => {
  ...
  return (
    <>
      <nav className="navbar navbar-dark bg-dark navbar-expand-lg d-print-none sticky-top" style={{paddingLeft: "1rem"}}>
        ...
        <div className={`${isNavCollapsed ? 'collapse' : ''} navbar-collapse`} id="navbarNav">
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <a className="nav-link" href="#" onClick={handlePrint}>Print</a>
            </li>
          </ul>
        </div>
      </nav>
